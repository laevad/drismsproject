                ...
                <div class="card widget" id="theoretical">
                    ...
                    <div class="col-md-3">
                        <div class="card widget" id="practical">
                            <a href="{{ route('student.scheduling.practical') }}"
                               class="btn btn-danger btn-icon pull-right @if($student_access_practical->isEmpty() && !$student_access_theoretical->isEmpty())  @else disabled  @endif"
                               style="color: white">
                                <i class="mdi mdi-blur-radial"></i>
                                Practical
                            </a>
