                                    ...
                                    @forelse($school_courses as $sc)
                                        @if($sc->course_id == $course->id)
                                            @if($sc->school_id == $school->id)
                                                <tr>
                                                    <td>
                                                        <input type="radio" name="ec_form{{$sc->id}}-{{$school->id}}" relAtt="{{ $n++ }}" class="ec_forn_c" rel="ec_form{{$sc->id}}-{{$school->id}}">
                                                    </td>
                                                    <td>{{ $course->name }}</td>
                                                ...
                                                <tr  class="dc-cls hidden" id="ec_form{{$sc->id}}-{{$school->id}}">
                                                    <td colspan ="10">
                                                            ...
                                                            <form method="POST" action="{{ route('registerStudent') }}" enctype="multipart/form-data">
                                                                ...
                                                                <div class="form-group row">
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <input id="fname" type="text" class="form-control @error('fname') is-invalid @enderror fname-{{ $n }}" name="fname" value="{{ old('fname') }}"  autocomplete="fname" autofocus>
                                                                        @error('fname')
                                                                ...
                                                                <div class="form-group row">
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <input id="phone" type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ old('phone') }}"  autocomplete="phone" autofocus placeholder="Tell or Phone number">
                                                                        @error('phone')
                                                                        <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                        </span>
                                                                        ...
                                                                        <div>
                                                                            <div class="form-check">
                                                                                <div class="d-flex justify-content-start">
                                                                                    <div class="d-inline">
                                                                                        <input id="male" type="radio" class=" @error('gender') is-invalid @enderror" name="gender" value="Male"  autocomplete="gender" autofocus>
                                                                                        <label class="form-check-label" for="male">
                                                                                            {{ __('Male') }}
                                                                                        </label>
                                                                                    </div>
                                                                                    <div class="d-inline ml-4">
                                                                                        <input id="female" type="radio" class=" @error('gender') is-invalid @enderror" name="gender" value="Female"  autocomplete="gender" autofocus>
