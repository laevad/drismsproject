...
{{--                            <td> {{ $val->end }} </td>--}}
                            ...
                            <td>
                                ...
                                <a
                                    href="{{ route("school.course.edit", $val->id) }}"
                                    class="btn btn-primary"
                                >
                                    <i class="mdi mdi-pencil"></i>
                                </a>

                                <form id="deleteSchedule{{$val->id}}"
                                      action="{{ route('school.course.delete', $val->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <a
                                        href="#"
                                        class="btn btn-danger fs_delete "
                                        rel="deleteSchedule{{$val->id}}"
                                    >
...
{{--                        <td>{{ $val->end }}</td>--}}
                        ...
                        <td>
                            ...
                            <form id="deleteFleetSchedule{{$val->id}}"
                                  action="{{ route('fleet.form.delete', $val->id)}} " method="POST">
                                @csrf
                                @method('DELETE')
                                <a
                                    href="#"
