...
class DashboardController extends Controller
{
    ...
    {   
        ...
        return view('dashboard', compact('student_access_practical','instructor_evaluation', 'student_certification', 'cstudent', 'cschool','fleets', 'cstaff','cinstructor', 'cnew_student', 'notifications', 'profile_pic', 'branches', 'days', 'student_courses', 'classes', 'schools', 'courses', 'school_courses'));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function showInstructorEvaluation($id){
         
        $instructor_evaluation = Evaluation::join('users as u', 'u.id', '=', 'evaluation.instructor_id') 
                                ->where([
                                    ['evaluation.instructor_id', '=', '$id'],
                                    ['u.role', '=', 'Instructor']
                                ])
                                ->get(['evaluation.*']);
                                 
        return view('admin/evaluation', compact('instructor_evaluation'));
    }
